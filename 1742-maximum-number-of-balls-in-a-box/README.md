<h2><a href="https://leetcode.com/problems/maximum-number-of-balls-in-a-box/?envType=problem-list-v2&envId=counting&difficulty=EASY&status=TO_DO">1742. Maximum Number of Balls in a Box</a></h2><h3>Easy</h3><hr><p>You are working in a ball factory where you have <code>n</code> balls numbered from <code>lowLimit</code> up to <code>highLimit</code> <strong>inclusive</strong> (i.e., <code>n == highLimit - lowLimit + 1</code>), and an infinite number of boxes numbered from <code>1</code> to <code>infinity</code>.</p>
